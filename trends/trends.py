...
def find_centroid(polygon):
    ...
    if area == 0:
        ...
        return (x/(6*area), y/(6*area), abs(area))
...
def find_state_center(polygons):
    ...
    x, y = 0, 0
    for i in polygons:
        total_area += find_centroid(i)[2]
        x += find_centroid(i)[0]*find_centroid(i)[2]
        y += find_centroid(i)[1]*find_centroid(i)[2]
    return make_position(x/total_area, y/total_area)
